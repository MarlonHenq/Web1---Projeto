...
public class GlobalExceptionHandler {
	...
	public String handleDuplicate(DataIntegrityViolationException ex, RedirectAttributes redirect) {
		log.error("Violação de integridade: {}", ex.getMessage());
		redirect.addFlashAttribute("erro", "Registro duplicado ou referência inválida.");
		return "redirect:/";
	}
